...
(install! centered-cursor-mode)
(install! evil-states-plus :recipe (:host github :repo "jgrey4296/evil-states-plus" :includes (paren-state)))
(install! better-jumper)
(install! imenu)
(install! avy)
(defer-load! "+vars")
