...
(install! rotate-text)
(install! evil-states-plus :recipe (:host github :repo "jgrey4296/evil-states-plus" :includes (insert-plus-state other-chars-state)))
(install! embrace)

;; Spelling
(install! spell-fu)
(install! flyspell-correct)
(install! flyspell-correct-ivy)
(install! flyspell-lazy)
...
(use! insert-plus-state)

(use! other-chars-state)
